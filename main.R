...
# Derive alpha and beta from introns ----

# 1. Load the intronic counts (generated by the Python script below)
intron_G <- fread("intron_counts_G_target.csv")
intron_C <- fread("intron_counts_C_target.csv")

# 2. Solve parameters
params_G <- solve_alpha_and_beta_from_introns(intron_G$k, intron_G$n)
params_C <- solve_alpha_and_beta_from_introns(intron_C$k, intron_C$n)
